namespace ProjectManager.Data.Repositories
{
	...
	public interface IProjectRepository
	{
		...
		/// <summary>
		///     Gets the specified number of most recent active projects.
		/// </summary>
		/// <param name="projectCount">The number of projects to return.</param>
		/// <param name="cancellationToken">The cancellation token.</param>
		/// <returns>An <see cref="IEnumerable{T}"/> containing the projects tied to the specified user.</returns>
		Task<IEnumerable<Project>> GetRecentActiveProjectsAsync(int projectCount, CancellationToken cancellationToken = default);
